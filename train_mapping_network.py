...
def train_one_epoch(data_loader, class_attributes_embeddings, class_attribute_prompt_list,
    ...
    for i, (images_batch, labels, images_clip_batch) in enumerate(pbar):
        ...
        start = 0
        for i, class_prompts in range(class_attribute_prompt_list):
        ...
        if cutmix_prob < 0.5:
            ...
            if len(correct_task_pim_incorrect) > 0:
                print(f"Correct task, incorrect pim: {correct_task_pim_incorrect}")
