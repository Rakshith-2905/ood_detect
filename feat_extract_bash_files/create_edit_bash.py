...
train_chunks = pd.read_csv("/g/g92/thopalli/ws_kdml/KDML/ood_detect/train_chunks.txt", sep='\t')
test_chunks = pd.read_csv("/g/g92/thopalli/ws_kdml/KDML/ood_detect/test_chunks.txt", sep='\t')
...
save_base_dir='feat_extract_bash_files_scripts'
...
for m in model:
    ...
    log_dir= os.path.join(f'/usr/workspace/KDML/ood_detect/feat_extract_bash_files/feat_logs')
