...
def get_save_dir(args):
    ...
    save_dir = os.path.dirname(os.path.dirname(args.step1_checkpoint_path))

    save_dir = os.path.join(save_dir, 'step_2', f'{args.domain_name}-{args.severity}')
...
def main(args):
    ...
    # NOTE: Uncomment this if you want to load the projector weights from step 1
