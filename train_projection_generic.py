...
if __name__ == "__main__":
    ...
    parser.add_argument('--feature_extractor_name', required=True, choices=['sam_vit_h', 'mae_vit_large_patch16', 'dino_vits16', 'resnet50', 'resnet50x1_bitm', 'resnetv2_101x1_bit.goog_in21k'],  help='Name of the feature extractor to use.')
