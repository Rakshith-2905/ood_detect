...
def generate_label_mapping_by_frequency(resnet_model, projector, CLIP_predictions, data_loader, mapping_num = 1):
    ...
    for x, y in pbar:
        ...
        with torch.no_grad():
            ...
            resnet_logits, resnet_embeddings = resnet_model(x, return_features=True)    
            proj_embeddings = projector(resnet_embeddings)
            fx0 = CLIP_predictions(proj_embeddings, text_encodings)
