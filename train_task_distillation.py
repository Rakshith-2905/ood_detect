...
def get_dataset(data_name, train_transforms, test_transforms, clip_transform, data_dir='../data', 
    ...
    if 'imagenet' in data_name.lower():
        ...
        dataset_dict, class_names = get_zsl_datasets(data_name, data_path=data_dir, preprocess=test_transforms)
...
def train_one_epoch_feat(data_loader, clip_model, classifier,
    ...
    for classifier_logits, classifier_embeddings, labels, clip_image_embeddings in pbar:
        ...
        # Cannot do image prompting as the image embeddings are already computed
...
def main(args):
    ...
    if args.cls_txt_prompts or args.dataset_txt_prompt:
