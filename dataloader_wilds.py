...
if __name__ == "__main__":
    ...
    data_set = WildsDataLoader(dataset_name=args.dataset, split=args.split, 
                                image_size=args.image_size, batch_size=args.batch_size, 
                                class_percentage=args.class_percentage, seed=args.seed)
    data_loader = data_set.load_data()
    data_set.display_details()
    train_classes = data_set.selected_classes
